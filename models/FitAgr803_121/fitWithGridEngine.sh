#### This script was launched with grid engine qsub. to execute a fit with MPI
#### use the bash shell
#!/bin/bash
#$ -S /bin/bash
...
/home/tbrookin/OpenMPI/bin/mpirun -mca btl self,tcp -np 72 /home/tbrookin/cpp/fitneuron/bin/fitneuron.bin -startup startFitAgr.txt -accuracy 1.0 -populationSize 1167
